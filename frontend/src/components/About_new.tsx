        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <motion.div variants={itemVariants} className="relative">
              <div className="line-art-border p-8 glass-effect rounded-2xl">
                <div className="relative h-96 bg-gradient-to-br from-accent-100 to-blueprint-100 rounded-xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    >
                      <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-r from-accent-400 to-blueprint-500 flex items-center justify-center">
                        <HiSparkles className="text-4xl text-white" />
                      </div>
                      <p className="technical-text text-blueprint-700">
                        Master Chef Artistry
                      </p>
                    </motion.div>
                  </div>
